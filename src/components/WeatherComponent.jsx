                  ...
                  <div className="flex flex-col items-center justify-between w-full gap-2">
                    ...
                    <div className="flex flex-col sm:flex-row justify-between gap-4 w-full">
                      <div className="text-sm space-y-2 sm:space-y-3">
                        <h3>
                          Wind:{" "}
                          <span className="font-light">{day.wind} km/h</span>
                        </h3>
                        <h3>
                          Pressure:{" "}
                          <span className="font-light">{day.pressure} hPa</span>
                        </h3>
                        <h3>
                          Humidity:{" "}
                          <span className="font-light">{day.humidity}%</span>
                        </h3>
                      </div>
                      <div className="text-sm pt-[53px] space-y-2 sm:space-y-3">
                        ...
                        <h3>
                          Sunrise:{" "}
                          <span className="font-light">{day.sunrise}</span>
                        </h3>
                      </div>
                    </div>
                  </div>
